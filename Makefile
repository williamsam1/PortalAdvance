...
PROGNAME = PortalAdvance

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = levels.o images/endScreen.o images/title.o images/portalGun.o images/door.o images/greyTile.o images/whiteTile.o images/companionCube.o font.o myLib.o main.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = levels.h images/endScreen.h images/title.h images/portalGun.h images/door.h images/greyTile.h images/whiteTile.h images/companionCube.h font.h myLib.h
